/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2f0da04edd7ee8b601213561be27beec)
// Runtime types generated with workerd@1.20260730.1 2026-08-06 nodejs_compat
interface __BaseEnv_Env {
	TUNECLUE_DB: D1Database;
	SHIPLEAN_SANDBOX: "false";
	AUDD_API_TOKEN: string;
	VITE_ENABLE_TIKTOK: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SHIPLEAN_SANDBOX" | "AUDD_API_TOKEN" | "VITE_ENABLE_TIKTOK">> {}
}
